                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(child: Text('Nomi (A - Z)'.tr, style: TextStyle(fontSize: _getController.width.value * 0.05, fontWeight: FontWeight.w500))),
                      ]
                    ),
                    SizedBox(height: _getController.width.value * 0.04),
                    Row(
                        children: [
                          Expanded(child: Text('Nomi (Z - A)'.tr, style: TextStyle(fontSize: _getController.width.value * 0.05, fontWeight: FontWeight.w500))),
                        ]
                    ),
                    const Divider(),
                    SizedBox(height: _getController.width.value * 0.04),
                    Row(
                        children: [
                          Expanded(child: Text('Avval arzonlari'.tr, style: TextStyle(fontSize: _getController.width.value * 0.05, fontWeight: FontWeight.w500))),
                        ]
                    ),
                    SizedBox(height: _getController.width.value * 0.04),
                    Row(
                        children: [
                          ...
                          Expanded(child: Text('Avval qimmatlari'.tr, style: TextStyle(fontSize: _getController.width.value * 0.05, fontWeight: FontWeight.w500))),
                        ]
                    ),
                    const Divider(),
                    SizedBox(height: _getController.width.value * 0.04),
                    Row(
                        children: [
                          ...
                          Expanded(child: Text('Yangisidan boshlab'.tr, style: TextStyle(fontSize: _getController.width.value * 0.05, fontWeight: FontWeight.w500))),
                        ]
                    ),
                    SizedBox(height: _getController.width.value * 0.04),
                    Row(
                        children: [
                          Expanded(child: Text('Top mahsulotdan boshlab'.tr, style: TextStyle(fontSize: _getController.width.value * 0.05, fontWeight: FontWeight.w500))),
                        ]
                    )
                  ],
                ));
                    ...
                    IconButton(
                      onPressed: () {
                        ...
                        ApiController().getProduct(
                            _getController.page.value, menuSlug, true);
                      },
                      icon: Icon(
                ...
                Expanded(
                    child: SmartRefresher(
                        ...
                        onLoading: () async {
                          if (!parent) {
                            ApiController()
                                .getProduct(_getController.page.value + 1,
                                    menuSlug, true)
                                .then((value) =>
                        ...
                        onRefresh: () async {
                          ...
                          if (!parent) {
                            ApiController().getProduct(1, menuSlug, false).then(
                                (value) =>
                        ...
                        child: GridView.builder(
                            gridDelegate:
                              ...
                              mainAxisExtent:
                                  _getController.height.value * 0.38,
                              mainAxisSpacing:
                                  _getController.height.value * 0.015,
                              crossAxisSpacing:
                                  _getController.width.value * 0.03,
                            ),
                            padding: EdgeInsets.only(
                                left: _getController.width.value * 0.025,
                                right: _getController.width.value * 0.025,
                                bottom: _getController.height.value * 0.02),
                            itemCount: _getController.productModelLength.value,
                            itemBuilder: (context, index) {
                              return ProductItem(
                                id: _getController.productModel.value.data!
                                    .result![index].sId!,
                                title: _getController.productModel.value.data!
                                    .result![index].name!,
                                deck: _getController.productModel.value.data!
                                    .result![index].slug!,
                                price: _getController.productModel.value.data!
                                    .result![index].price!
                                    .toString(),
                                imageUrl: _getController.productModel.value
                                        .data!.result![index].image ??
                                    '',
                                count: _getController.productModel.value.data!
                                        .result![index].count ??
                                    0,
                                function: () {
                                  ...
                                  Get.to(() => DetailPage(
                                      slug: _getController.productModel.value
                                          .data!.result![index].slug!,
                                      pageIndex: 0));
                                },
                              );
                            })))
