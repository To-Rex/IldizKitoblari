                ...
                Positioned(
                    ...
                    child:  Container(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(
                                        ...
                                        child: Checkbox(
                                            ...
                                            activeColor: AppColors.primaryColor, value: _getController.check.value,
                                    ...
                                    InkWell(
                                        ...
                                        child: Text('Ommaviy oferta'.tr, style: TextStyle(color: AppColors.primaryColor, fontSize: _getController.width.value * 0.035))
                                    ),
                                    Text(' ${'shartlariga roziman'.tr}!', style: TextStyle(color: Theme.of(context).colorScheme.onSurface, fontSize: _getController.width.value * 0.035))
                                  ]
                              ),
                        ...
                        child: ElevatedButton(
                            ...
                            child: Text('Ro‘yxatdan o‘tish'.tr, style: TextStyle(fontSize: _getController.width.value * 0.04, color: AppColors.white, fontWeight: FontWeight.bold))
                        )
                    ),
                              ...
                              Row(
                                  children: [
                                    ...
                                    InkWell(
                                        ...
                                        child: Text('Kirish'.tr, style: TextStyle(color: AppColors.primaryColor, fontSize: _getController.width.value * 0.04, fontWeight: FontWeight.bold))
                                    ),
                                    const Spacer(),
                                  ]
                              ),
