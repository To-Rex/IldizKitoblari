...
class Data {
  ...
  Data({this.sId, this.status, this.deliveryStatus, this.isLosed, this.uid, this.type, this.price, this.deliveryPrice, this.district, this.city, this.address, this.orderProducts, this.country});
