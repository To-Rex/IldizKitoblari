          ...
          children: [
            ...
            Expanded(child: Column(
              ...
              children: [
                ...
                Text('${widget.subTitle} ${'ta kitob'.tr}',
                    style: TextStyle(fontSize: _getController.width.value * 0.035, color: Theme.of(context).colorScheme.onSurface, fontWeight: FontWeight.w500))
              ]
            )),
