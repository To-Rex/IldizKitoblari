  ...
  Widget build(BuildContext context) {
    return Obx(() => Column(
        children: [
          ...
          if (_getController.basketModel.value.data != null && _getController.basketModel.value.data!.result != null && _getController.basketModel.value.data!.result!.isNotEmpty)
            Container(
                margin: EdgeInsets.only(top: 5.sp, bottom: 18.sp, left: Get.width * 0.03, right: Get.width * 0.03),
                child: Divider(height: 1, color: Theme.of(context).colorScheme.onSurface.withOpacity(0.2))),
          if (_getController.basketModel.value.data != null && _getController.basketModel.value.data!.result != null && _getController.basketModel.value.data!.result!.isNotEmpty)
            ListView.separated(
                                ...
                                child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text('uz_UZ' == Get.locale.toString()
                                        ...
                                        style: TextStyle(color: Theme.of(context).colorScheme.onSurface, fontSize: 17.sp, fontWeight: FontWeight.bold)),
                                      const Spacer(),
                                      Text('${_getController.basketModel.value.data!.result![index].price} ${'so‘m'.tr}',maxLines: 1, style: TextStyle(color: AppColors.primaryColor2, fontSize: 17.sp, fontWeight: FontWeight.bold)),
                                      const Spacer(),
                                      Row(
                                        children: [
                                          InkWell(
