    ...
    return Obx(() => Column(children: [
          if (_getController.basketModel.value.data != null && _getController.basketModel.value.data!.result != null && _getController.basketModel.value.data!.result!.isNotEmpty)
            Row(children: [
              ...
              Text(
                  '${'Barchasini tanlash'.tr} (${_getController.basketModel.value.data!.result!.length}) ')
            ]),
          if (_getController.basketModel.value.data != null && _getController.basketModel.value.data!.result != null && _getController.basketModel.value.data!.result!.isNotEmpty)
            Container(
              ...
              Row(children: [
                ...
                Container(
                    ...
                    margin: EdgeInsets.only(
                        right: Get.width * 0.02, bottom: Get.height * 0.015),
                    decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(5),
                        image: DecorationImage(
                          image: NetworkImage(_getController
                              .basketModel.value.data!.result![i].image!),
                        ))),
                SizedBox(
                    width: Get.width * 0.5,
                    height: Get.height * 0.15,
                    child: Column(
                        ...
                        children: [
                          Text(_getController
                              .basketModel.value.data!.result![i].name!.uz!),
                          Text(
                              '${_getController.basketModel.value.data!.result![i].price} ${'so‘m'.tr}',
                              style: TextStyle(
                              ...
                              Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Text(_getController.basketModel.value.data!
                                        .result![i].cartCount
                                        .toString()),
                                    IconButton(
                                        color: Theme.of(context)
