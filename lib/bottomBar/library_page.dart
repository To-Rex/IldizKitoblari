                                    ...
                                    Container(
                                        ...
                                        child: Container(
                                            ...
                                            child: TabBar(
                                                ...
                                                tabs: [
                                                  Tab(child: SizedBox(width: Get.width * 0.6, child: Center(child: Text('Elektron kitoblar'.tr,maxLines: 1,overflow: TextOverflow.ellipsis)))),
                                                  Tab(child: SizedBox(width: Get.width * 0.6, child: Center(child: Text('Audio kitoblar'.tr,maxLines: 1,overflow: TextOverflow.ellipsis))))
                                                ]
                                            )
                                        )
                                    ),
